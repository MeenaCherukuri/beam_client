          ...
          <div className="text-center mb-12 lg:mb-16">
            ...
            <div className="max-w-4xl mx-auto space-y-4 text-base sm:text-lg md:text-xl text-gray-600 mb-8">
              ...
              <div className="inline-flex items-center gap-2 text-gray-700">
                ...
                <a 
                  href="/signup" 
                  className="md:relative md:inline-block px-2  ml-2 text-white  hover:bg-blue-700 rounded-2xl transition-all duration-300 transform hover:scale-105 font-medium hover:border-blue-200 shadow-lg"
                >
                  Sign Up
                </a>
              </div>
